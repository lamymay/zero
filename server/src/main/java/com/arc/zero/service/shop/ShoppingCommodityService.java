package com.arc.zero.service.shop;
...
*/
public interface ShoppingCommodityService {
    ...
    * @return 数据集合
    */
    Page<ShoppingCommodity> listPage(ShoppingCommodityRequest shoppingCommodityRequest);
