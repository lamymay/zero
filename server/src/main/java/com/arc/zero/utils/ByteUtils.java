...
public final class ByteUtils {
    ...
    public static long fromLittleEndian(org.apache.commons.compress.utils.ByteUtils.ByteSupplier supplier, int length) throws IOException {
        checkReadLength(length);
        long l = 0L;
    ...
    public static void toLittleEndian(org.apache.commons.compress.utils.ByteUtils.ByteConsumer consumer, long value, int length) throws IOException {
        long num = value;
